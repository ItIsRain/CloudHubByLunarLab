...
const integrations: Integration[] = [
  ...
  },
  {
    id: "github",
    name: "GitHub",
    description: "Link repositories and track competition project submissions.",
    color: "bg-gray-800",
    letter: "G",
  },
  {
...
const webhookEvents = [
  ...
  { event: "competition.registration.created", description: "New competition registration" },
  { event: "competition.registration.cancelled", description: "Competition registration cancelled" },
