...
export const mockCommunities: Community[] = [
  {
    ...
    tags: ["tech", "networking", "san-francisco"],
    socials: {},
    createdAt: subtractDays(365),
    updatedAt: subtractDays(10),
  },
...
export const mockMessages: Message[] = [
  ...
  { id: "msg-1", conversationId: "conv-1", senderId: "user-1", sender: mockUsers[0], content: "Hey Sarah! Are you joining BuildAI 2024? We need a designer on our team.", type: "text", createdAt: subtractDays(3) + "T10:00:00" },
  { id: "msg-2", conversationId: "conv-1", senderId: "user-2", sender: mockUsers[1], content: "Hi Alex! Yes, I'm definitely interested. What track are you targeting?", type: "text", createdAt: subtractDays(3) + "T10:15:00" },
  { id: "msg-3", conversationId: "conv-1", senderId: "user-1", sender: mockUsers[0], content: "AI/ML Innovation track. We have a great idea for an AI-powered productivity tool.", type: "text", createdAt: subtractDays(3) + "T10:20:00" },
  { id: "msg-4", conversationId: "conv-1", senderId: "user-2", sender: mockUsers[1], content: "That sounds awesome! I'd love to handle the design and UX.", type: "text", createdAt: subtractDays(3) + "T10:25:00" },
  { id: "msg-5", conversationId: "conv-1", senderId: "user-1", sender: mockUsers[0], content: "Perfect! I'll send you the team invite. Welcome aboard!", type: "text", createdAt: subtractDays(2) + "T09:00:00" },
  // Conversation 2 — Alex & Marcus
  { id: "msg-6", conversationId: "conv-2", senderId: "user-3", sender: mockUsers[2], content: "Hey Alex, just reviewed your Climate Hack submission. Amazing work on EcoTrack AI!", type: "text", createdAt: subtractDays(40) + "T14:00:00" },
  { id: "msg-7", conversationId: "conv-2", senderId: "user-1", sender: mockUsers[0], content: "Thanks Marcus! Your feedback during mentoring really helped us refine the ML model.", type: "text", createdAt: subtractDays(40) + "T14:30:00" },
  { id: "msg-8", conversationId: "conv-2", senderId: "user-3", sender: mockUsers[2], content: "Happy to help! Have you thought about turning it into a real product? I know some investors who might be interested.", type: "text", createdAt: subtractDays(39) + "T10:00:00" },
  { id: "msg-9", conversationId: "conv-2", senderId: "user-1", sender: mockUsers[0], content: "Absolutely! We've been discussing that as a team. Would love an intro.", type: "text", createdAt: subtractDays(39) + "T11:00:00" },
  { id: "msg-10", conversationId: "conv-2", senderId: "user-3", sender: mockUsers[2], content: "I'll set up a meeting next week. Let me know your availability.", type: "text", createdAt: subtractDays(1) + "T16:00:00" },
  // Conversation 3 — Alex & Emma
  { id: "msg-11", conversationId: "conv-3", senderId: "user-4", sender: mockUsers[3], content: "Hey! Are you coming to ETHGlobal SF? I heard you're interested in Web3.", type: "text", createdAt: subtractDays(10) + "T09:00:00" },
  { id: "msg-12", conversationId: "conv-3", senderId: "user-1", sender: mockUsers[0], content: "Hi Emma! Yes, I registered yesterday. Still looking for a team though.", type: "text", createdAt: subtractDays(10) + "T09:30:00" },
...
export const mockConversations: Conversation[] = [
  {
    ...
    type: "direct",
    createdBy: "user-1",
    lastMessageAt: subtractDays(2) + "T09:00:00",
    lastMessagePreview: "Perfect! I'll send you the team invite. Welcome aboard!",
    unreadCount: 1,
    otherParticipant: mockUsers[1],
    createdAt: subtractDays(3) + "T10:00:00",
  ...
  },
  {
    ...
    type: "direct",
    createdBy: "user-3",
    lastMessageAt: subtractDays(1) + "T16:00:00",
    lastMessagePreview: "I'll set up a meeting next week. Let me know your availability.",
    unreadCount: 1,
    otherParticipant: mockUsers[2],
    createdAt: subtractDays(40) + "T14:00:00",
  ...
  },
  {
    ...
    type: "direct",
    createdBy: "user-4",
    lastMessageAt: subtractDays(10) + "T10:00:00",
    lastMessagePreview: "Sounds great! Let's chat more about it over coffee before the event.",
    unreadCount: 0,
    otherParticipant: mockUsers[3],
    createdAt: subtractDays(10) + "T09:00:00",
  ...
  },
  {
    ...
    type: "direct",
    createdBy: "user-5",
    lastMessageAt: subtractDays(4) + "T09:00:00",
    lastMessagePreview: "Good call. I'll set up the Lambda functions.",
    unreadCount: 1,
    otherParticipant: mockUsers[4],
    createdAt: subtractDays(5) + "T13:00:00",
